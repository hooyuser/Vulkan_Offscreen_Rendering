...
private:
	...
	void offlineRender() {
		...
		ubo.proj = glm::perspective(glm::radians(90.0f), texWidth / (float)texHeight, 0.1f, 10.0f);
		ubo.proj[1][1] *= -1;
	...
	void createDepthResources() {
		...
		createImage(texWidth, texHeight, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
